...
namespace WebAPI.Areas.Admin.Controllers.MVC
{
    public class RoomsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "RoomID,RoomName,GenreRoomID,StatusRoom")] Room room)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "RoomID,RoomName,GenreRoomID,StatusRoom")] Room room)
        {
            if (ModelState.IsValid)
            {
